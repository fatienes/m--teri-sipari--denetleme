<%@ Page Title="MusteriSiparis" Language="C#" MasterPageFile="~/Ana.Master" AutoEventWireup="true" CodeBehind="sf_Urunler.aspx.cs" Inherits="MusteriSiparis.sf_Urunler" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">       
        $(document).ready(function () {
            ...
            $("#nav-log-Urunler").addClass("active");
            if (gup('op') == "l")
                $("#nav2-log-Urunler").addClass("active");
            else
                $("#nav2-log-Urunler").addClass("active");
        });
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
                ...
                <div class="text-center">
                        <h2 class="font-weight-bold text-center">Ürünler</h2>
                    </div>
                <div class="row">
                    <div class="col-2">
                            <div class="form-group">
                                <label class="font-weight-bold"> Ürün Adı</label>
                                <asp:TextBox ID="txt_UrunAdi" runat="server" Style="width: 100%" placeholder="Ürün adı" CssClass="form-control" autocomplete="off"></asp:TextBox>
                            </div>
                        </div>
                    <div class="col-2">
                            <div class="form-group">
                                <label>Ürün Türü </label>
                                <asp:DropDownList ID="ddl_UrunTuru" runat="server" Style="width: 100%" CssClass="form-control select2"></asp:DropDownList>
                            </div>
                        </div>
                    <div class="col-lg-2">
                            <div class="form-group">
                    ...
                    <div class="col-lg-2">
                            <div class="form-group">
                                <label>&nbsp;</label>
                                <a href="pop_UrunEkle.aspx" class="btn btn-primary btn-block iframe"><i class="simple-icon-user-follow"></i> Ürün Ekle
                                </a>
                            </div>
                        </div>
                </div>
                                ...
                                <table class="table table-striped data-table-standard" id="dataTable" data-order="[[ 1, &quot;desc&quot; ]]" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"> Ürün Türü </th>
                               ...
                               <tr>
                                ...
                                <b><span  style="color:<%# Eval("aktif_pasif").ToString() == "1" ? "green" : "red"%>"><%# Eval("aktif_pasif").ToString() == "1" ? "Aktif" : "Pasif"%></span></b>
                                   ...
                                   <td class="text-center">
                                       ...
                                       <a href='pop_UrunEkle.aspx?id=<%#Eval("id")%>' data-toggle="tooltip" data-placement="top" title="Güncelle" style="color:white ;background-color:darkblue;" class="btn iframe">
